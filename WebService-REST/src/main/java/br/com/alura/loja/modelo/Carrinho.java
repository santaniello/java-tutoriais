...
// Usando JAXB para serializar (caso eu queira usar Xtream é so tirar essas anotações)
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD) // Falando que todos os campos devem ser serializados por padrão
